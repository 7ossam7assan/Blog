    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Category</h3>
             <a class="col-lg-offset-5 btn btn-primary" href="{{route('category.create')}}">Create Category</a>
        </div>
        <!-- /.box-header -->
         <div class="box">
                ...
                <tbody>
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td>
                                <a class="primary btn-success" href="{{route('category.edit',$category->id)}}">Edit<i class="fa fa-fw fa-edit"></i></a>
                            </td>
                            <td>
